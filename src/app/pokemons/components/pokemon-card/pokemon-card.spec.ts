...
describe('PokemonCardComponent', () => {
  ...
  it('should render the pokemon name and image properly', () => {
  ...
  it('should have the proper ng-reflect-router-link', () => {
    ...
    const divWithRouterLink = compiled.querySelector('div');
    expect(divWithRouterLink?.attributes.getNamedItem('ng-reflect-router-link')?.value).toBe(`/pokemon,${mockPokemon.name}`);
  });
